...
def _norm_keys(row):
    # lower-case keys for flexible matching
...
class DataLoader:
    ...
    def _read_geojson(self, name):
        ...
        try:
            ...
            # if LFS pointer file was pulled without LFS, return empty
            return {"type":"FeatureCollection","features":[]}
    ...
    def _ensure_districts(self):
        ...
        debt = {  # map by district id if available
            _get(r, "district_6","district","district id","district_n","district_nu","distid","isd","lea") : r
        ...
        for r in finances:
            ...
            # spending: prefer explicit total; else sum common categories; else 0
            ...
            if total_spend == 0:
                cat_keys = [
                    ...
                    "co-curricular","facilities","debt service","transportation","food service",
                    "other"
                ]
            ...
            # attach debt if we can find it
            dd = debt.get(drow["district_6"])
            if dd:
